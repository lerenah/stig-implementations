<#
.SYNOPSIS
    Remediates WN11-AU-000500 by configuring the Application event log
...
.USAGE
    ...
    PS C:\> .\WN11-AU-000500.ps1 | Tee-Object -FilePath .\WN11-AU-000500_evidence.txt
#>
...
Write-Host "`n=== WN11-AU-000500 Remediation: Application Event Log Size ===`n"
