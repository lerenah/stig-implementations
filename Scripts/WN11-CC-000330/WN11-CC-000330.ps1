<#
.SYNOPSIS
    Remediates WN11-CC-000330 by disabling Basic authentication
...
.USAGE
    ...
    PS C:\> .\WN11-CC-000330.ps1 | Tee-Object -FilePath .\WN11-CC-000330_evidence.txt
#>
...
Write-Host "`n=== WN11-CC-000330 Remediation: Disable WinRM Client Basic Authentication ===`n"
